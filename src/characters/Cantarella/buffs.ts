export const buffs = [
  {
    ...
    details: `Increase Healing Bonus by 20%.`,
    hasStacks: false,
    modifiers: [
      {
  ...
  },
  {
    ...
    details: `<div class="skilldescription">Casting <span class="Highlight">Echo Skill</span> gives 6% Havoc DMG Bonus for 10s, stacking up to 2 times.</div>`,
    hasStacks: true,
    modifiers: [
      {
        modifier: "Havoc",
