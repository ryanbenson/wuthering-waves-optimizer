export const resonanceChains = [
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_ZanniM1_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "Spectro",
  ...
  },
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_ZanniM2_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "CritRate",
  ...
  },
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_ZanniM3_UI.webp`,
    hasStacks: true,
    modifiers: [
      {
  ...
  },
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_ZanniM4_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "ATK",
  ...
  },
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_ZanniM5_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "talentModifierMultiply",
  ...
  },
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_ZanniM6_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "talentModifierMultiply",
