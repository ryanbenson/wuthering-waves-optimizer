...
export const carlottaKitchenSinkStats: StatTests = [
  { selector: ".stat-atk", value: "4,300" },
  { selector: ".stat-hp", value: "17,261" },
  { selector: ".stat-def", value: "1,222" },
  { selector: ".stat-cr", value: "93.5%" },
  { selector: ".stat-cd", value: "330.0%" },
  { selector: ".stat-er", value: "102.0%" },
  { selector: ".stat-basic", value: "2.0%" },
  { selector: ".stat-heavy", value: "2.0%" },
  { selector: ".stat-skill", value: "189.5%" },
  { selector: ".stat-liberation", value: "2.0%" },
  { selector: ".stat-glacio", value: "96.5%" },
