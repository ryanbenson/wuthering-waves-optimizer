...
export default {
    ...
    computed: {
        ...
        echo1Data() {
            return this.echo1Id ? this.echoById(this.echo1Id) : null;
        },
        echo2Data() {
            return this.echo2Id ? this.echoById(this.echo2Id) : null;
        },
        echo3Data() {
            return this.echo3Id ? this.echoById(this.echo3Id) : null;
        },
        echo4Data() {
            return this.echo4Id ? this.echoById(this.echo4Id) : null;
        },
        echo5Data() {
            return this.echo5Id ? this.echoById(this.echo5Id) : null;
        },
        ...
        // Total values
        totalRv() {
            return this.echo1Rv + this.echo2Rv + this.echo3Rv + this.echo4Rv + this.echo5Rv;
        },
        totalCv() {
            return this.echo1Cv + this.echo2Cv + this.echo3Cv + this.echo4Cv + this.echo5Cv;
        },
