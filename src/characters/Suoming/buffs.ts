export const buffs = [
  ...
  },
  {
    ...
    details: `<div>When Suoming has <span style="color:#ffd12f;" class="font-bold">Unison</span> and is switched out, she gains the <span style="color:#ffd12f;" class="font-bold">Aligned Seals</span> effect for 30s.<br>While <span style="color:#ffd12f;" class="font-bold">Aligned Seals</span> is active, within 8s after Suoming casts <span style="color:#ffd12f;" class="font-bold">Resonance Liberation</span> or <span style="color:#ffd12f;" class="font-bold">Basic Attack - Umbral Canopy: Engraved Heart</span>, Suoming's <span style="color:#ffd12f;" class="font-bold">Outro Skill</span> grants the incoming Resonator 30% Electro DMG Bonus, plus an additional 20% for each stack of <span style="color:#ffd12f;" class="font-bold">Unison Boon</span> they have, up to 40%. This effect lasts for 8s or until the Resonator is switched out.<br><br>When Suoming has <span style="color:#ffd12f;" class="font-bold">Unison</span>, casting <span style="color:#ffd12f;" class="font-bold">Resonance Skill - Furled Canopy: Rift Cleaver</span> removes <span style="color:#ffd12f;" class="font-bold">UnisUnisonon</span>, consumes 20 points of Concerto Energy, and clears all <span style="color:#ffd12f;" class="font-bold">Delusion</span>, granting the <span style="color:#ffd12f;" class="font-bold">Seal Master</span> effect: the DMG Multipliers of <span style="color:#ffd12f;" class="font-bold">Basic Attack - Unfurled Canopy</span> and <span style="color:#ffd12f;" class="font-bold">Basic Attack - Unfurled Canopy: Whirling Thunder</span> are increased by 100%, each stage of the skills restores 5 points of Concerto Energy on hit, and Suoming's Crit. DMG is increased by 100%. This effect lasts for 12s or until the Resonator is switched out.<br>- Gaining <span style="color:#ffd12f;" class="font-bold">Unison</span> ends this effect early.<br>- Gaining the <span style="color:#ffd12f;" class="font-bold">Aligned Seals</span> effect ends this effect early.<br>- The <span style="color:#ffd12f;" class="font-bold">Seal Master</span> effect cannot be gained while the <span style="color:#ffd12f;" class="font-bold">Aligned Seals</span> effect is active.<br>- While the <span style="color:#ffd12f;" class="font-bold">Seal Master</span> effect is active, press <span style="color:#ffd12f;" class="font-bold">Normal Attack</span> shortly after casting <span style="color:#ffd12f;" class="font-bold">Basic Attack - Unfurled Canopy Stage 4</span> to chain into <span style="color:#ffd12f;" class="font-bold">Basic Attack - Unfurled Canopy Stage 2</span>.</div>`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "talentModifierMultiply",
        modifySpecificTalents: [
          "BasicAttackUnfurledCanopyStage1DMG",
          "BasicAttackUnfurledCanopyStage2DMG",
          "BasicAttackUnfurledCanopyStage3DMG",
          "BasicAttackUnfurledCanopyStage4DMG",
          "BasicAttackUnfurledCanopyWhirlingThunderStage1DMG",
          "BasicAttackUnfurledCanopyWhirlingThunderStage2DMG",
        ],
        modifierValue: 0.4,
      },
      {
