const weaponInfo: WeaponInfo = {
  ...
  passiveData: [
    ...
    },
    {
      ...
      maxStacks: 0,
      details:
        "When casting an Intro Skill, you gain [Yearly Essence] which increase Resonance Skill DMG by 24%/30%/36%/42%/48% for 12s.",
      alwaysEnabled: false,
    },
    {
      key: "ResonanceSkillDMGBonus2",
      hasStacks: false,
      modifier: "ResonanceSkillDMGBonus",
      modifierByRefinement: {
        "1": 0.24,
      ...
      maxStacks: 0,
      details:
        "When casting a Resonance Skill, you gain [Blessings] which increase Resonance Skill DMG by 24%/30%/36%/42%/48% for 12s",
      alwaysEnabled: false,
    },
  ],
};
