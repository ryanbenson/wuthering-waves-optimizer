<template>
  <div class="damage-breakdown">
    ...
    <div v-if="damage.totalDamageContext.type === 'spectroFrazzle'" class="damage-breakdown--spectroFrazzle">
      <div class="formula bg-base-200 p-2 rounded-md font-mono">
        <span class="font-bold text-secondary">{{ displayDamage(damage.damage) }}</span> = 
        (1000
          ×
          <span class="text-primary">{{ displayPercentage(damage.totalDamageContext.resistModifier * 100, 2) }}</span>
          ×
          <span class="text-primary">{{ displayPercentage(damage.totalDamageContext.defModifier * 100, 10) }}</span>
          ×
      ...
      <div class="font-bold mt-2 text-lg text-primary"> Defense modifier </div>
        <div class="formula bg-base-200 p-2 rounded-md font-mono">
          <span class="text-secondary font-bold">{{ displayPercentage(damage.totalDamageContext.defModifier * 100, 10) }}</span>
          =
          (800
            +
            8
    ...
    </div><div v-if="damage.totalDamageContext.type === 'aeroErosion'" class="damage-breakdown--aeroErosion">
      <div class="formula bg-base-200 p-2 rounded-md font-mono">
        <span class="font-bold text-secondary">{{ displayDamage(damage.damage) }}</span> = 
        (1000
          ×
