...
export const characterSubstatPriorities: Record<string, SubstatWeights> = {
  ...
  Aemeath: { CritRate: 4, CritDMG: 4, EnergyRegen: 1, ATK: 2, ResonanceLiberationDMGBonus: 1.5, ATK_FLAT: 1 },
  Augusta: { CritRate: 3.5, CritDMG: 4, EnergyRegen: 1, ATK: 1.5, HeavyAttackDMGBonus: 1.5, ATK_FLAT: 0.5 },
  Brant: { EnergyRegen: 2, CritRate: 4, CritDMG: 4, BasicAttackDMGBonus: 3, ATK: 2, ATK_FLAT: 1 },
  Buling: { CritRate: 3, CritDMG: 4, EnergyRegen: 1, ATK: 2.5, ResonanceSkillDMGBonus: 0.5, ResonanceLiberationDMGBonus: 2, BasicAttackDMGBonus: 1, ATK_FLAT: 1.5 },
  Calcharo: { EnergyRegen: 2, CritRate: 4, CritDMG: 4, ATK: 2, ResonanceLiberationDMGBonus: 3, ATK_FLAT: 1 },
  Camellya: { CritRate: 3, CritDMG: 4, EnergyRegen: 1, ATK: 2, BasicAttackDMGBonus: 1, ATK_FLAT: 1 },
  Cantarella: { EnergyRegen: 2, CritRate: 4, CritDMG: 4, ATK: 2, BasicAttackDMGBonus: 3, ATK_FLAT: 1 },
  Carlotta: { CritRate: 4, CritDMG: 2.5, EnergyRegen: 1, ATK: 2, ResonanceSkillDMGBonus: 1.5, ATK_FLAT: 1 },
  Cartethyia: { CritRate: 4, CritDMG: 1, EnergyRegen: 1, HP: 2, BasicAttackDMGBonus: 1.5, ResonanceSkillDMGBonus: 0.5, ResonanceLiberationDMGBonus: 0.5, HP_FLAT: 0.5 },
  Changli: { EnergyRegen: 2, CritRate: 4, CritDMG: 4, ATK: 2, ResonanceSkillDMGBonus: 3, ATK_FLAT: 1 },
  Chisa: { CritRate: 4, CritDMG: 4, EnergyRegen: 1, ATK: 2.5, ResonanceLiberationDMGBonus: 2, ATK_FLAT: 1.5 },
  Ciaccona: { CritRate: 4, CritDMG: 2.5, EnergyRegen: 1, ATK: 2.5, BasicAttackDMGBonus: 0.5, HeavyAttackDMGBonus: 0.5, ResonanceLiberationDMGBonus: 1, ATK_FLAT: 1.5 },
  Danjin: { CritRate: 4, CritDMG: 4, EnergyRegen: 2, ATK: 2, ATK_FLAT: 1 },
  Denia: { CritRate: 4, CritDMG: 4, EnergyRegen: 1, ATK: 2, ResonanceLiberationDMGBonus: 2, ATK_FLAT: 1 },
  Encore: { EnergyRegen: 2, CritRate: 4, CritDMG: 4, ATK: 2, BasicAttackDMGBonus: 3, ATK_FLAT: 1 },
  Galbrena: { CritRate: 4, CritDMG: 3.5, EnergyRegen: 1, ATK: 1.5, HeavyAttackDMGBonus: 1, ATK_FLAT: 1 },
  Hiyuki: { CritRate: 3.5, CritDMG: 4, EnergyRegen: 1, ATK: 2, ResonanceLiberationDMGBonus: 1.5, ATK_FLAT: 1 },
  Iuno: { CritRate: 3.5, CritDMG: 4, EnergyRegen: 1, ATK: 2, ResonanceLiberationDMGBonus: 2, ATK_FLAT: 1 },
  Jianxin: { CritRate: 4, CritDMG: 4, ATK: 2, EnergyRegen: 2, ResonanceLiberationDMGBonus: 3, ATK_FLAT: 1 },
  Jinhsi: { CritRate: 4, CritDMG: 2.5, EnergyRegen: 1, ATK: 2, ResonanceSkillDMGBonus: 1.5, ResonanceLiberationDMGBonus: 0.5, ATK_FLAT: 1 },
  Jingran: { CritRate: 4, CritDMG: 4, EnergyRegen: 1, HP: 0.5, HeavyAttackDMGBonus: 1.5, ATK: 1, ATK_FLAT: 0.5 },
  Jiyan: { EnergyRegen: 2, CritRate: 4, CritDMG: 4, ATK: 2, HeavyAttackDMGBonus: 3, ATK_FLAT: 1 },
  Lucilla: { CritRate: 3.5, CritDMG: 4, EnergyRegen: 1, ATK: 2, BasicAttackDMGBonus: 1.5, ResonanceSkillDMGBonus: 0.5, ATK_FLAT: 1 },
  Lucy: { CritRate: 4, CritDMG: 3.5, EnergyRegen: 1, ATK: 1.5, HeavyAttackDMGBonus: 1.5, ATK_FLAT: 1 },
  Lupa: { CritRate: 4, CritDMG: 3, EnergyRegen: 1, ATK: 2, ResonanceLiberationDMGBonus: 1.5, ATK_FLAT: 1 },
  LuukHerssen: { CritRate: 4, CritDMG: 3.5, EnergyRegen: 1, ATK: 2, BasicAttackDMGBonus: 1.5, ATK_FLAT: 1 },
  Lynae: { CritRate: 4, CritDMG: 4, EnergyRegen: 1, ATK: 2, BasicAttackDMGBonus: 1.5, ResonanceLiberationDMGBonus: 0.5, ATK_FLAT: 1 },
  ...
  Phrolova: { CritRate: 4, CritDMG: 4, EnergyRegen: 1, ATK: 2, ResonanceSkillDMGBonus: 1, ATK_FLAT: 1 },
  Qiuyuan: { CritRate: 3.5, CritDMG: 4, EnergyRegen: 1, ATK: 2, HeavyAttackDMGBonus: 1, ATK_FLAT: 1 },
  Qingxiao: { CritRate: 4, CritDMG: 4, EnergyRegen: 1, ATK: 2, HeavyAttackDMGBonus: 1, ATK_FLAT: 1.5, ResonanceLiberationDMGBonus: 1, BasicAttackDMGBonus: 1 },
  Rebecca: { CritRate: 4, CritDMG: 3, EnergyRegen: 1, ATK: 1.5, BasicAttackDMGBonus: 1.5, ATK_FLAT: 1 },
  ...
  Suisui: { CritRate: 2.5, CritDMG: 4, EnergyRegen: 1, ATK: 1, HP: 2, BasicAttackDMGBonus: 2, ResonanceSkillDMGBonus: 0.5, ATK_FLAT: 1, HP_FLAT: 0.5 },
  Verina: { EnergyRegen: 2, ATK: 2, ATK_FLAT: 1 },
  XiangliYao: { CritRate: 3, CritDMG: 4, EnergyRegen: 1, ATK: 2, ResonanceSkillDMGBonus: 0.5, ResonanceLiberationDMGBonus: 1, ATK_FLAT: 1 },
  YangyangXuanling: { CritRate: 4, CritDMG: 3, EnergyRegen: 1, ATK: 2, HeavyAttackDMGBonus: 2, ATK_FLAT: 1 },
