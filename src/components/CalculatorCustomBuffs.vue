  ...
  <div class="custom__buffs">
    ...
    <div class="custom__buffs-list">
          <div>
            ...
            >
            <span><input type="number" v-model="ATK" min="0" name="ATK" id="ATK"></span>
          </div>
          <div>
            <span
              ><img
                src="https://ryanbenson.github.io/wuthering-waves-assets/images/atk.png" />Flat Attack</span
            >
            <span><input type="number" v-model="ATK_FLAT" min="0" name="ATK_FLAT" id="ATK_FLAT"></span>
          </div>
          <div>
            <span
              ><img
            ...
            >
            <span><input type="number" v-model="HP" min="0" name="HP" id="HP"></span>
          </div>
          <div>
            <span
              ><img
                src="https://ryanbenson.github.io/wuthering-waves-assets/images/hp.png" />Flat HP</span
            >
            <span><input type="number" v-model="HP_FLAT" min="0" name="HP_FLAT" id="HP_FLAT"></span>
          </div>
          <div>
            <span
              ><img
            ...
            >
            <span><input type="number" v-model="DEF" min="0" name="DEF" id="DEF"></span>
          </div>
          <div>
            <span
              ><img
                src="https://ryanbenson.github.io/wuthering-waves-assets/images/def.png" />Flat Defense</span
            >
            <span><input type="number" v-model="DEF_FLAT" min="0" name="DEF_FLAT" id="DEF_FLAT"></span>
          </div>
          <div>
            <span
              ><img
              ...
              Rate</span
            >
            <span><input type="number" v-model="CritRate" min="0" name="CritRate" id="CritRate"></span>
          </div>
          <div>
            <span
              ><img
              ...
              DMG</span
            >
            <span><input type="number" v-model="CritDMG" min="0" name="CritDMG" id="CritDMG"></span>
          </div>
          <div>
            <span
              ><img
              ...
              Regen</span
            >
            <span><input type="number" v-model="EnergyRegen" min="0" name="EnergyRegen" id="EnergyRegen"></span>
          </div>
          <div>
            <span
              ><img
            ...
            >
            <span><input type="number" v-model="BasicAttackDMGBonus" min="0" name="BasicAttackDMGBonus" id="BasicAttackDMGBonus"></span>
          </div>
          <div>
            <span
              ><img
              ...
              Attack DMG Bonus</span
            >
            <span><input type="number" v-model="HeavyAttackDMGBonus" min="0" name="HeavyAttackDMGBonus" id="HeavyAttackDMGBonus"></span>
          </div>
          <div>
            <span
              ><img
            ...
            >
            <span><input type="number" v-model="ResonanceSkillDMGBonus" min="0" name="ResonanceSkillDMGBonus" id="ResonanceSkillDMGBonus"></span>
          </div>
          <div>
            <span
              ><img
            ...
            >
            <span><input type="number" v-model="ResonanceLiberationDMGBonus" min="0" name="ResonanceLiberationDMGBonus" id="ResonanceLiberationDMGBonus"></span>
          </div>
          <div>
            <span
              ><img
            ...
            >
            <span><input type="number" v-model="Glacio" min="0" name="Glacio" id="Glacio"></span>
          </div>
          <div>
            <span
              ><img
            ...
            >
            <span><input type="number" v-model="Fusion" min="0" name="Fusion" id="Fusion"></span>
          </div>
          <div>
            <span
              ><img
            ...
            >
            <span><input type="number" v-model="Electro" min="0" name="Electro" id="Electro"></span>
          </div>
          <div>
            <span
              ><img
            ...
            >
            <span><input type="number" v-model="Aero" min="0" name="Aero" id="Aero"></span>
          </div>
          <div>
            <span
              ><img
            ...
            >
            <span><input type="number" v-model="Spectro" min="0" name="Spectro" id="Spectro"></span>
          </div>
          <div>
            <span
              ><img
            ...
            >
            <span><input type="number" v-model="Havoc" min="0" name="Havoc" id="Havoc"></span>
          </div>
          <div>
            <span
              ><img
              ...
              Bonus</span
            >
            <span><input type="number" v-model="HealingBonus" min="0" name="HealingBonus" id="HealingBonus"></span>
          </div>
        </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    ResonanceLiberationDMGBonus: {
      get() {
        return this.currentCharacter?.customBuffs?.ResonanceLiberationDMGBonus ?? 0;
      },
      async set(value) {
        const data = {
          customBuffs: {
