  ...
  <ul class="menu menu-horizontal px-1">
    ...
    <li>
      <a
        ...
        class="calcations__nav--icon-svg calcations__nav--rotations mr-2 h-12 p-0 flex justify-center min-w-[48px] min-h-[48px]"
    ...
    <li>
      <a
        ...
        class="calcations__nav--icon-svg calcations__nav--custom-buffs mr-2 h-12 p-0 flex justify-center min-w-[48px] min-h-[48px]"
