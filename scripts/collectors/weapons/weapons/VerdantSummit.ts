...
const weaponInfo: WeaponInfo = {
  ...
  "passiveValue": "Increases the DMG Bonus of all Resonance Attributes by 12%/15%/18%/21%/24%. Every time Intro Skill or Resonance Liberation is cast, increases Heavy Attack DMG Bonus by 24%/30%/36%/42%/48%, stacking up to 2 time(s). This effect lasts for 14s."
};
