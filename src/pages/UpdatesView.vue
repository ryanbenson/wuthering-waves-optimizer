<template>
  ...
  <article class="prose page-updates">
    ...
    <h3>July 11, 2026</h3>
    <ul>
      <li>Adds echo presets for Cantarella, Chisa, Ciaccona, Denia, Iuno, Lucilla.</li>
    </ul>
    <h3>July 10, 2026</h3>
    <ul>
    ...
    <h3>June 12, 2026</h3>
    <ul>
      <li>Releases Lucilla</li>
    </ul>
    <h3>June 8, 2026</h3>
    <ul>
      <li>Fixes some Lucy and Rebecca buffs.</li>
    </ul>
    <h3>June 7, 2026</h3>
    <ul>
    ...
    <ul>
      ...
      <li>
        Updates the max stacks on NS on enemy page. you dont need to activate
        chisa, etc to get the max possible stacks. i dont have the dmg for them
        yet. ill try to figure that soon
      </li>
    </ul>
    ...
    <ul>
      <li>
        Fixed icons in a few views where the icon was filling up the whole
        button space.
      </li>
      <li>
    ...
    <h3>April 28, 2025</h3>
    <ul>
      <li>Releases Zani and her signature.</li>
    </ul>
    <h3>April 27, 2025</h3>
    <ul>
    ...
    <ul>
      ...
      <li>
        Fixed some bugs in the navigation on secondary pages and optimized the
        code for the navigation systems.
      </li>
    </ul>
    <h3>April 4, 2025</h3>
    <ul>
    ...
    <ul>
      ...
      <li>Fixed weapon name for Overture.</li>
    </ul>
    ...
    <ul>
      <li>Adds Vitreum Dancer echo</li>
    </ul>
    ...
    <ul>
      ...
      <li>Removes stacks from Undying Flame.</li>
    </ul>
    ...
    <ul>
      <li>Fixes Calcharo S6. It is now behind a toggle.</li>
      <li>
    ...
    <ul>
      <li>
        Fixes issue when you change weapons, sometimes the buffs wouldn't clear
        out from the previous weapon.
      </li>
    </ul>
    <h3>November 9, 2024</h3>
    <ul>
      <li>
        Fixes issue when you change characters and sometimes the weapon passives
    ...
    <ul>
      ...
      <li>Adds missing flat ATK and DEF (30).</li>
    </ul>
    ...
    <h3>July 26, 2024</h3>
    <ul>
      <li>Updates Xiangli Yao, and Zhezhi for latest 1.2 beta changes.</li>
      <li>
    ...
    <h3>July 23, 2024</h3>
    <ul>
      <li>Rover Havoc is now available.</li>
    </ul>
    <h3>July 21, 2024</h3>
    <ul>
    ...
    <ul>
      ...
      <li>
        Fixes Changli inherit skill and S1 to only affect specific skills stated
        in the description
      </li>
    </ul>
    <h3>June 23, 2024</h3>
