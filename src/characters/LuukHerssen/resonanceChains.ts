...
When in the <span class="Highlight">Aureate Judge</span> state, casting Resonance Skill Aureole of Execution grants 1 stacks of Dawnlit Keep.</div>`,
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_LuhesiM1_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
...
When Luuk Herssen deals damage to targets inflicted with Tune Strain - Interfered, every 10 points of Tune Break Boost he has now Amplify this instance of damage by 10%. This effect now increases the DMG Amplification up to 60% instead of 30%.</div>`,
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_LuhesiM2_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
...
Perpetuating Daytime now stacks up to 4 times.</div>`,
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_LuhesiM3_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "talentModifierMultiply",
  ...
  },
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_LuhesiM4_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "DMGBonus",
...
Resonance Skill <span class="Highlight">Golden Reflux</span> has its DMG Multiplier increased by 50% and Cooldown reduced by 2s, and gains 1 more charge.</div>`,
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_LuhesiM5_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifySpecificTalents: [
...
When Luuk Herssen deals damage to targets inflicted with <span class="Highlight">Tune Strain - Interfered</span>, the stack count of <span class="Highlight">Tune Strain - Interfered</span> on the target is increased by 2. This effect ignores the max stack limit.</div>`,
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_LuhesiM6_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
