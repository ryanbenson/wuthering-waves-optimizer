export const resonanceChains = [
  ...
  },
  {
    ...
    details: `<div><span style="color:#f7ca2f"><strong>Basic Attack - Iai</strong></span>'s DMG Multiplier is increased by 125%.<br><br>Inherent Skill <span style="color:#f7ca2f"><strong>Ephemeral Realm</strong></span>'s effect becomes the following one:<br>Once Hiyuki leaves the combat state or recovers from being knocked out, after staying out of combat for 4s, restore 3 points of <span style="color:#f7ca2f"><strong><a href="#WwLink110805" data-ww-link-id="110805">Snowforged Blade</a></strong></span>.<br><br>Once Hiyuki leaves the combat state or recovers from being knocked out, after staying out of combat for 4s, the following effects are triggered once:<br>- Restore 3 points points of <span style="color:#f7ca2f"><strong><a href="#WwLink110803" data-ww-link-id="110803">Frostharden Iai</a></strong></span>.<br>- Reset the Cooldown of 2 charges of <span style="color:#f7ca2f"><strong>Frostblight: Jade Cleave</strong></span>.<br>- Restore an additional 50 points of <span style="color:#f7ca2f"><strong><a href="#WwLink110802" data-ww-link-id="110802">Frostheart</a></strong></span> for the next 2 casts of <span style="color:#f7ca2f"><strong>Frostblight: Jade Cleave</strong></span> or <span style="color:#f7ca2f"><strong>Frostblight: Petalfall</strong></span>.</div>`,
    hasStacks: false,
    modifiers: [
      {
