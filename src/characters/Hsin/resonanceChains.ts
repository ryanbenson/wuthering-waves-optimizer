export const resonanceChains = [
  {
    ...
    details: `<div>Casting <span style="color:#ffd12f;" class="font-bold">Resonance Liberation - Formshift</span> grants Hsin 2 stacks of <span style="color:#ffd12f;" class="font-bold">Radiance Ward</span>, stacking up to 2 times. Switching to <span style="color:#ffd12f;" class="font-bold">Answering Form</span> clears all stacks. When Hsin takes DMG from an enemy target's attack, 1 stack of <span style="color:#ffd12f;" class="font-bold">Radiance Ward</span> can be consumed to make Her immune to interruption and reduce DMG taken by 60% for 1s. This effect can be triggered once every 1s.<br><br>While in <span style="color:#ffd12f;" class="font-bold">Resonance Mode - Electro Flare</span>:<br>When Hsin enters combat, if <span style="color:#ffd12f;" class="font-bold">Heart of Thunder</span> is below 50 stacks, it is increased to 50 stacks, triggered once every 4s.<br>The DMG Multiplier of <span style="color:#ffd12f;" class="font-bold">Electro Flare</span> DMG dealt when <span style="color:#ffd12f;" class="font-bold">Forte Circuit - Resonance Skill: Illumining Form</span> hits a target and consumes 5 stacks of <span style="color:#ffd12f;" class="font-bold">Heart of Thunder</span> is increased to 210%. The DMG Multiplier of <span style="color:#ffd12f;" class="font-bold">Electro Flare</span> DMG dealt when <span style="color:#ffd12f;" class="font-bold">Forte Circuit - Resonance Skill: Heartward by Moon</span> consumes all remaining <span style="color:#ffd12f;" class="font-bold">Heart of Thunder</span> at once is increased to 42%.</div>`,
