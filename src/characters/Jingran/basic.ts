export function getCharacterBasicInfo(): CharacterBasicInfo {
  return {
    ...
    gender: "male",
    element: "Fusion",
    image: "https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconRolePile/T_IconRole_Pile_jingran_UI.webp",
    ...
    suggestedWeapons: [
      { key: "ThunderflareDominion", label: "Alternate" },
      { key: "RadianceCleaver", label: "Standard" },
      { key: "AureateZenith", label: "BP" },
      { key: "HeliosCleaver", label: "4*" },
    ],
  };
}
