export const resonanceChains = [
  ...
  },
  {
    ...
    details: `<div><span style="color:#f7ca2f"><strong>Basic Attack - Iai</strong></span>'s DMG Multiplier is increased by 125%.<br><br>Inherent Skill <span style="color:#f7ca2f"><strong>Ephemeral Realm</strong></span>'s effect becomes the following one:<br>Once Hiyuki leaves the combat state or recovers from being knocked out, after staying out of combat for 4s, restore 3 points of <span style="color:#f7ca2f"><strong><span class="Highlight">Snowforged Blade</span></strong></span>.<br><br>Once Hiyuki leaves the combat state or recovers from being knocked out, after staying out of combat for 4s, the following effects are triggered once:<br>- Restore 3 points points of <span style="color:#f7ca2f"><strong><span class="Highlight">Frostharden Iai</span></strong></span>.<br>- Reset the Cooldown of 2 charges of <span style="color:#f7ca2f"><strong>Frostblight: Jade Cleave</strong></span>.<br>- Restore an additional 50 points of <span style="color:#f7ca2f"><strong><span class="Highlight">Frostheart</span></strong></span> for the next 2 casts of <span style="color:#f7ca2f"><strong>Frostblight: Jade Cleave</strong></span> or <span style="color:#f7ca2f"><strong>Frostblight: Petalfall</strong></span>.</div>`,
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_FeixueM2_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "talentModifierMultiply",
  ...
  },
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_FeixueM4_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "DMGBonus",
      ...
      },
      {
        ...
        modifierValue: ["SequenceNode4LikeReedsonTides"],
      },
    ],
    minStacks: 0,
    maxStacks: 0,
  ...
  },
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_FeixueM5_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "talentModifierMultiply",
  ...
  },
  {
    ...
    details: `<div>The Crit. DMG of <span style="color:#f7ca2f"><strong>Foreclaiming: Inward Vision</strong></span> and <span style="color:#f7ca2f"><strong>Foreclaiming: Blade Liberation</strong></span> are increased by 500%.<br><br>At 2 stacks of <span style="color:#f7ca2f"><strong>Snow Rust</strong></span>, the effect "While Hiyuki is the active Resonator in the team, each time she applies <span style="color:#f7ca2f"><strong><span class="Highlight">Glacio Chafe</span></strong></span>, she additionally deals an instance of Glacio Bite DMG with a fixed DMG Multiplier" changes to "While Hiyuki is the active Resonator in the team, each time a Resonator in the team applies <span style="color:#f7ca2f"><strong><span class="Highlight">Glacio Chafe</span></strong></span>, she additionally deals an instance of Glacio Bite DMG with a fixed DMG Multiplier."<br>At 2 stacks of <span style="color:#f7ca2f"><strong>Snow Rust</strong></span>, Hiyuki's Crit. DMG is increased by 40%.<br>At 3 stacks of <span style="color:#f7ca2f"><strong>Snow Rust</strong></span>, the total <span style="color:#f7ca2f"><strong><span class="Highlight">Glacio Bite</span> DMG</strong></span> taken by targets within a certain range of the active Resonator in the team is increased by 25%.</div>`,
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_FeixueM6_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "CritDMG",
