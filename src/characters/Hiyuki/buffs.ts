export const buffs = [
  ...
  },
  {
    ...
    details: `<div>Once Hiyuki leaves the combat state or recovers after being knocked out, when she stays out of combat for 4s with has fewer than 1 point of <span style="color:#f7ca2f"><strong><a href="#WwLink110805" class="underline decoration-dotted underline-offset-2 hover:cursor-help hover:text-accent" data-ww-link-id="110805">Snowforged Blade</a></strong></span>, restore 1 point.</div>`,
    hasStacks: false,
    modifiers: [],
    minStacks: 0,
    maxStacks: 0,
