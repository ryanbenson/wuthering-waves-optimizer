export const resonanceChains = [
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_BailianM1_UI.webp`,
    hasStacks: false,
    modifiers: [],
    minStacks: 0,
    maxStacks: 0,
  ...
  },
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_BailianM2_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "Glacio",
  ...
  },
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_BailianM3_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "HP",
  ...
  },
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_BailianM4_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
  ...
  },
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_BailianM5_UI.webp`,
    hasStacks: false,
    modifiers: [],
    minStacks: 0,
    maxStacks: 0,
  ...
  },
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_BailianM6_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "Glacio",
