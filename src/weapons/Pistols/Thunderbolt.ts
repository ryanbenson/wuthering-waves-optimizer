const weaponInfo: WeaponInfo = {
  ...
  passiveData: [
    {
      key: "ThunderboltResonanceSkillDMGBonus",
      hasStacks: true,
      ...
      maxStacks: 3,
      details:
        "When hitting a target with Basic Attacks or Heavy Attacks, increases Resonance Skill DMG Bonus by 7%/11%/15%/19%/23%, stacking up to 3 time(s)",
      alwaysEnabled: false,
    },
  ],
};
