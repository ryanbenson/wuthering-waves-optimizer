export const resonanceChains = [
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_DaniyaM1_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "CritDMG",
  ...
  },
  {
    ...
    details: `<div>The DMG Multiplier of Resonance Skill <span style="color:#f7ca2f"><strong>Banish - Breakdown Form</strong></span> is increased by 40%.</div>`,
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_DaniyaM2_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
  ...
  },
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_DaniyaM3_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "talentModifierMultiply",
  ...
  },
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_DaniyaM4_UI.webp`,
    hasStacks: false,
    modifiers: [],
    minStacks: 0,
    maxStacks: 0,
  ...
  },
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_DaniyaM5_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "talentModifierMultiply",
  ...
  },
  {
    ...
    details: `<div>While in <span style="color:#f7ca2f"><strong><span class="Highlight">Entropy Shift</span></strong></span> states, gain 60% ATK increase and 60% Fusion DMG Bonus.</div>`,
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_DaniyaM6_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "ATK",
