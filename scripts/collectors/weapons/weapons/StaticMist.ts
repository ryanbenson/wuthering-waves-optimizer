...
const weaponInfo: WeaponInfo = {
  ...
  "passiveValue": "Increases Energy Regen by 12.8%/16%/19.2%/22.4%/25.6%. When Outro Skill is released, increases the switched-in Resonator's ATK by 10%/12.5%/15%/17.5%/20%, stacking up to 1 time(s). This effect lasts for 14s."
};
