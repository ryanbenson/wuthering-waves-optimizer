import { config, dataAttacks, dataStats } from "../data/Chisa/data";
import { testAttacks } from "../utils/attackUtils";
import { testStats } from "../utils/statUtils";

describe("Calculator Data Verification: Chisa", () => {
  beforeEach(() => {
    cy.visit("/");
  });
  ...
  it("should import data then verify stats and damages", () => {
    ...
    cy.get(".character__selection.Chisa").should("be.visible");
