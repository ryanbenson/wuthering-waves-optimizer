export const resonanceChains = [
  ...
  },
  {
    ...
    details: `<div>The DMG Multipliers of <span style="color:#ffd12f;" class="font-bold">Heavy Attack - Soul Raid</span> and <span style="color:#ffd12f;" class="font-bold">Heavy Attack - Stardome Meander</span> are increased by 40%. While in the <span style="color:#ffd12f;" class="font-bold">Yinghuo</span> state, the DMG Multiplier increase of <span style="color:#ffd12f;" class="font-bold">Heavy Attack - Soul Raid</span> and <span style="color:#ffd12f;" class="font-bold">Heavy Attack - Stardome Meander</span> is increased by 40%.<br><size=10></span><br><br>Upon engaging in a combat, Jingran gains the following effects:<br>- Restore 4 points of <span style="color:#ffd12f;" class="font-bold">Qi</span>.<br>- When Jingran's <span style="color:#ffd12f;" class="font-bold">Ghost Shroud</span> is below 300 point, restore to 25 stacks.<br>- Jingran gains <span style="color:#ffd12f;" class="font-bold">Netherworld's Boon</span>.<br><size=10></span><br><br><span class="Title">Netherworld's Boon</span></span><br><br><span style="color:#ffd12f;" class="font-bold">Heavy Attack - Soul Raid</span> and <span style="color:#ffd12f;" class="font-bold">Heavy Attack - Stardome Meander</span> gain 25 DMG Amplification for 180%s.</div>`,
    hasStacks: false,
    modifiers: [],
    minStacks: 0,
    maxStacks: 0,
