export const resonanceChains = [
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_ZhezhiM2_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "CritRate",
  ...
  },
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_ZhezhiM3_UI.webp`,
    hasStacks: true,
    modifiers: [
      {
        modifier: "ATK",
  ...
  },
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_ZhezhiM4_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "ATK",
  ...
  },
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_ZhezhiM5_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
  ...
  },
  {
    ...
    icon: `https://api.encore.moe/resource/Data/Game/Aki/UI/UIResources/Common/Image/IconDevice/T_IconDevice_ZhezhiM6_UI.webp`,
    hasStacks: false,
    modifiers: [
      {
        modifier: "EnableAttack",
