export const resonanceChains = [
  ...
  },
  {
    ...
    details: `<span class="skilldescription">DMG Multiplier percentage for Resonance Skill <span class="Highlight">Illuminous Epiphany</span> is increased by 45%. The multiplier increase brought by Incandescence is additionally increased by 71%.</span>`,
    hasStacks: false,
    modifiers: [
      {
        modifySpecificTalents: ["SolarFlareDMG", "StarGlamourDMG"],
